...
ServerEvents.recipes((event) => {
  ...
  splashing("biomesoplenty:orange_sand", "create:copper_nugget", 1, 1, "create:copper_nugget", 0.75, 1);
  ...
  splashing("minecraft:gravel", "minecraft:flint", 0.25, 1, "minecraft:iron_nugget", 1, 1);
